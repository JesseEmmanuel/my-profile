...
export default function Skill() {
  ...
  return (
    <div className="w-full md:flex md:flex-col">
      ...
      <section id="skills" className="py-10 bg-background pt-12 sm:pt-10">
          ...
          <div className="flex flex-wrap gap-8 justify-center items-stretch">
            {skillCategories.map((category, index) => {
              return (
                <Card
                  key={index}
                  className=" flex flex-col justify-between hover:shadow-lg dark:shadow-gray-400 transition-all duration-300 hover:-translate-y-1 w-[400px] border-2 border-[#101A36] dark:border-white rounded-none"
                >
